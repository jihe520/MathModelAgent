...
%  编译方式：xelatex main.tex （需运行两遍以生成交叉引用）
% =============================================================================
...
\newcommand{\aiusagedeclaration}[1]{%
  \section*{AI工具使用声明}%
  #1\par
}
% \appendixcn：附录节，包含支撑材料文件列表和完整源程序
...
% 电子版第一页为摘要专用页，页码从 1 开始连续编号
\papertitle{CUMCM-TEMPLATE-PLACEHOLDER}
...
\newpage
\aiusagedeclaration{本参赛队在竞赛过程中使用了AI工具，主要用于〖CUMCM-TEMPLATE-PLACEHOLDER〗，详细使用情况见支撑材料。}
\newpage
\referencescn
\newpage
\appendixcn
